...
function LeftSidebar() {
    return(
        <>
            <div className="flex left-sidebar bg-000300 w-full md:w-1/12 p-4 md:sticky md:top-0 md:left-0 md:order-first sm:order-last md:h-screen flex-col items-center justify-center text-center sm:px-5">
