...
function RightSidebar() {
    return(
        <>
            <div className="right-sidebar bg-000300 w-full md:w-2/12 p-4 md:sticky md:top-0 md:right-0 sm:fixed left-[-500%] h-screen flex flex-col items-center justify-center">
