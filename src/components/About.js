...
import languages from '../images/Timeline.png'

function About(){
    return (
        <div className="w-full bg-white py-16 px-4 scroll-mt-20" id="About">
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
                <img className="w-[450px] mx-auto my-4 rounded-lg" src={chunfoto} alt="Foto Chun die op muur zit." />
                <div className="flex flex-col justify-center">
                    ...
                    <p className="py-2">
                        My name is Chun-Hin and I am 18 years old. I study Software Development (Level 4) at the Deltion college in Zwolle.
                    </p>
                    <p className="py-2">
                    ...
                    <img className="w-[825px] mx-auto my-4 rounded-lg" src={languages} alt="Tijdslijn geleerde talen van Chun." />
                </div>
            </div>
        </div>
    );
